...
LABEL version="0.8"
LABEL description="This is an image for the IPM Decisions DWD-EU weather adapter covering Europe"
...
USER ipmdecisions
RUN echo "30 * * * *  cd /opt/ipmdecisions/perl; ./run > ./download.log" | crontab
